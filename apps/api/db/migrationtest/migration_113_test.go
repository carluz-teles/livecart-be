...
// Teste da migration 000113: o Modo Live (produto em destaque + pausa) desce
// para a sessão.
//
...
//     sessão);
//  4. live_events continua com as colunas (expand — o DROP é a 000121);
...
func TestMigration000113SessionLiveMode(t *testing.T) {
	adminURL := mustEnv(t)
	...
	if n != 2 {
		t.Errorf("live_events perdeu colunas na 000113 (%d de 2) — o contract e a 000121", n)
	}
