...
// Teste da migration 000122 (CONTRACT) com DADO semeado.
//
...
//     sao a whitelist de verdade desde a 000112).
...
func TestMigration000122ContractDropEventLevel(t *testing.T) {
	adminURL := mustEnv(t)
