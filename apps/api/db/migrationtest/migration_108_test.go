...
// Teste da migration 000108: cupom uma vez por COMPRADOR na campanha (RN-33).
//
// O caso que a 000107 criou: pagar abre um 2º carrinho no mesmo evento, e a
...
func TestMigration000108CouponPerBuyer(t *testing.T) {
	adminURL := mustEnv(t)
	...
	// Dois carrinhos do MESMO comprador no mesmo evento — legal desde a 000107.
