...
// Teste da migration 000117: a unique da midia vira PARCIAL.
//
// O que precisa ficar provado:
//  1. antes da 000117 a unique global existe e o reuso e IMPOSSIVEL;
...
func TestMigration000117LspMediaUniqueSwap(t *testing.T) {
	adminURL := mustEnv(t)
	...
	if err := bind(julhoSession, "post-fixado"); err == nil {
		t.Fatal("a unique global deixou reusar a midia antes da 000117 — o teste nao esta medindo o que acha")
	}
