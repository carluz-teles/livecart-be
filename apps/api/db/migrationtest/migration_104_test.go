...
// Teste da migration 000104 sobre dados LEGADOS: aplica ate a 000103, semeia
// linhas com os valores que a 000104 tem de converter (0 e a faixa 1..14),
// aplica a 000104 e confere conversao, CHECKs e o down.
//
...
func TestMigration000104OverLegacyData(t *testing.T) {
	adminURL := mustEnv(t)
