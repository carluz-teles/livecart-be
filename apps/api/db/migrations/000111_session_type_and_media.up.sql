...
-- que ainda lê event.type, não quebrar de uma vez. O DROP é a 000121 (contract).
...
COMMENT ON COLUMN live_sessions.type IS
    'D3: natureza da transmissão (live|post|reel|story). Fonte da verdade do tipo. live_events.type sobrevive como rótulo legado do vocabulário antigo (single|multi|post|story) até a 000121; ''reel'' é gravado lá como ''post'' para não quebrar o FE.';
