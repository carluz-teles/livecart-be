...
--
-- PRE-REQUISITO DE DEPLOY, nao opcional: o trigger da 000116 tem de estar de pe
...
--
-- Seguranca: igual a 000107, o indice novo cobre um SUBCONJUNTO das linhas da
...
COMMENT ON INDEX uq_lsp_media_in_flight IS
    'D22: uma midia pertence a no maximo UM evento vivo por vez. Midias liberadas (released_at NOT NULL) podem ser reaproveitadas numa campanha nova. O predicado so e expressavel porque a 000116 denormalizou live_events.status em released_at.';
