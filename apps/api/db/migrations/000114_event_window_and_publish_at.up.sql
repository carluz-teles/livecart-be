...
-- create/update) e a constraint de banco so entra na 000121.
...
COMMENT ON COLUMN live_events.starts_at IS
    'D21: inicio da JANELA COMERCIAL da campanha. Nao e a data de publicacao da midia (essa e live_sessions.publish_at). Mantido em sincronia com scheduled_at ate a 000121.';
COMMENT ON COLUMN live_events.ends_at IS
    'D5: TETO da campanha. Obrigatorio para eventos NOVOS (validado na aplicacao). A obrigatoriedade no banco entra na 000121, depois do backfill dos legados.';
