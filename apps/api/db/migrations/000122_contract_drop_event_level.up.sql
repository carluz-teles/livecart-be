...
--   4. a whitelist le session_products (000112);
--   5. o Modo Live e da sessao (000113); as quatro queries de evento estavam
...
--   8. o trigger da 000116 mantem live_session_platforms.released_at, entao
--      nenhuma midia fica presa.
--
-- ORDEM: a 000121 LE live_events.type no reparo 1:1. Ela tem de ter rodado.
...
-- desde a 000111. Manter a copia no evento nao era redundancia inofensiva: um
...
-- live_sessions desde a 000113. Duas transmissoes simultaneas compartilhavam o
...
-- =============================================================================
-- A verdade esta em session_products desde a 000112, e a sessao nova herda a
...
-- =============================================================================
-- As 000111/000112/000114 documentaram as colunas dizendo "ate a 000121" — a
-- numeracao do plano, que deslocou em um quando a 000118 foi usada pelo motivo
