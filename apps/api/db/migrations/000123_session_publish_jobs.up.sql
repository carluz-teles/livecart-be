-- 000123 — Publicacao agendada no Instagram (RN-31 / N3). FATIA DESTACAVEL:
-- nada mais no epico depende desta tabela.
--
-- Numeracao: o plano reservava a 000122 para esta tabela, mas a 000118 foi
-- consumida pelo motivo de nao entrega (RN-38) e tudo deslocou em um. O
-- CONTRACT ficou na 000122; o agendamento vem aqui.
--
...
CREATE TABLE session_publish_jobs (
    ...
    -- existe desde a 000114 e nunca teve escritor.
