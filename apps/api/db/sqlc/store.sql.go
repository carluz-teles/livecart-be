...
func (q *Queries) CreateStore(ctx context.Context, arg CreateStoreParams) (Store, error) {
	...
	err := row.Scan(
		...
		&i.CartAllowEdit,
		&i.WaitlistClaimMinutes,
		&i.WaitlistExpiryMinutes,
	)
	return i, err
}
