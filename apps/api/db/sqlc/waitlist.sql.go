...
RETURNING id, event_id, product_id, platform_user_id, platform_handle, quantity, position, status, notified_at, fulfilled_at, expires_at, created_at, cart_id, notification_sent_at, cancelled_at, unit_price, original_quantity, fulfilled_quantity, cancelled_quantity, source_command, queue_sequence, price_lot_id
`
...
SELECT id, event_id, product_id, platform_user_id, platform_handle, quantity, position, status, notified_at, fulfilled_at, expires_at, created_at, cart_id, notification_sent_at, cancelled_at, unit_price, original_quantity, fulfilled_quantity, cancelled_quantity, source_command, queue_sequence, price_lot_id FROM waitlist_items
WHERE event_id = $1 AND product_id = $2 AND status = 'waiting'
...
SELECT wi.id, wi.event_id, wi.product_id, wi.platform_user_id, wi.platform_handle, wi.quantity, wi.position, wi.status, wi.notified_at, wi.fulfilled_at, wi.expires_at, wi.created_at, wi.cart_id, wi.notification_sent_at, wi.cancelled_at, wi.unit_price, wi.original_quantity, wi.fulfilled_quantity, wi.cancelled_quantity, wi.source_command, wi.queue_sequence, wi.price_lot_id,queued.queue_position,
...
SELECT wi.id, wi.event_id, wi.product_id, wi.platform_user_id, wi.platform_handle, wi.quantity, wi.position, wi.status, wi.notified_at, wi.fulfilled_at, wi.expires_at, wi.created_at, wi.cart_id, wi.notification_sent_at, wi.cancelled_at, wi.unit_price, wi.original_quantity, wi.fulfilled_quantity, wi.cancelled_quantity, wi.source_command, wi.queue_sequence, wi.price_lot_id FROM waitlist_items wi WHERE FALSE
`
...
SELECT wi.id, wi.event_id, wi.product_id, wi.platform_user_id, wi.platform_handle, wi.quantity, wi.position, wi.status, wi.notified_at, wi.fulfilled_at, wi.expires_at, wi.created_at, wi.cart_id, wi.notification_sent_at, wi.cancelled_at, wi.unit_price, wi.original_quantity, wi.fulfilled_quantity, wi.cancelled_quantity, wi.source_command, wi.queue_sequence, wi.price_lot_id, p.name AS product_name, p.keyword AS product_keyword, p.image_url AS product_image_url
