...
type StartERPResyncResponse struct {
	Progress *ERPResyncProgress `json:"progress,omitempty"`
...
type IntegrationResponse struct {
	ERPResync *ERPResyncProgress `json:"erpResync,omitempty"`
	ID        string             `json:"id"`
	...
	Metadata  map[string]any     `json:"metadata,omitempty"`
	// Compatibility fields mirror the durable checkpoint, including its final counters.
...
type ERPProductResponse struct {
	GroupImported  bool                   `json:"groupImported,omitempty"`
