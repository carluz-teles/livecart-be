...
var baselineRawThrows = map[string]bool{
	// Importação: 404/validação de entrada e configuração de conexão.
	// Inclui os guards de credenciais compartilhadas já presentes na base de produção.
	"erp.Tiny.getProduct:\"Produto não encontrado no ERP\"":                                                                                              true,
	"integration.Handler.SearchProducts:\"Parâmetros de busca inválidos\"":                                                                               true,
	"integration.ImportERPProductRequest.ToInput:\"Integração inválida\"":                                                                                true,
	"integration.ImportERPProductRequest.ToInput:\"Loja inválida\"":                                                                                      true,
	"integration.ImportERPProductRequest.ToInput:\"Produto inválido\"":                                                                                   true,
	"integration.Repository.Delete:\"Este Instagram atende outras lojas. Desvincule essas lojas antes de excluir a conexão principal.\"":                 true,
	"integration.Repository.createInstagram:\"Instagram já conectado. Use a conexão existente.\"":                                                        true,
	"integration.Repository.resolveIntegrationRow:\"Vínculo de credenciais Instagram inválido.\"":                                                        true,
	"integration.SearchERPProductsRequest.ToInput:\"Digite pelo menos dois caracteres\"":                                                                 true,
	"integration.SearchERPProductsRequest.ToInput:\"Integração inválida\"":                                                                               true,
	"integration.SearchERPProductsRequest.ToInput:\"Loja inválida\"":                                                                                     true,
	"integration.Service.Create:\"Instagram já conectado. Use a reconexão pelo OAuth.\"":                                                                 true,
	"integration.Service.GetERPProductDetails:\"Produto inválido\"":                                                                                      true,
	"integration.Service.ImportERPProduct:\"Produto inválido\"":                                                                                          true,
	"integration.Service.ImportERPProduct:\"Produto não encontrado no ERP\"":                                                                             true,
	"integration.Service.ImportERPProduct:\"Selecione até 5 variantes por etapa de importação\"":                                                         true,
	"integration.Service.ReadCatalogProduct:\"Escolha as variantes para importar este produto\"":                                                         true,
	"integration.Service.ReadCatalogProduct:\"Produto inválido\"":                                                                                        true,
	"integration.Service.ReadCatalogProduct:\"Produto não encontrado no ERP\"":                                                                           true,
	"integration.Service.StartERPResync:\"conecte uma integração de ERP ativa para sincronizar os produtos\"":                                            true,
	"integration.Service.createProviderFromRow:\"A conexão compartilhada do Instagram não está ativa.\"":                                                 true,
	"integration.Service.refreshInstagramToken:\"A conexão Instagram não está ativa. Verifique a conexão principal.\"":                                   true,
	"integration.Service.refreshInstagramToken:\"A conexão principal do Instagram não está ativa.\"":                                                     true,
	"integration.Service.requireInstagramAuthorizationOwner:\"Este Instagram é compartilhado. Reconecte pela loja responsável pela conexão principal.\"": true,
	"integration.Service.saveInstagramAuthorization:\"O Instagram autorizado difere da conta compartilhada. Autorize o mesmo perfil.\"":                  true,
	"integration.Service.saveInstagramAuthorization:\"Reconecte o Instagram pela conexão principal.\"":                                                   true,
	"integration.Service.tinyOAuthIntegration:\"Integração Tiny não encontrada\"":                                                                        true,
	"integration.readERPProductDetails:\"Produto não encontrado no ERP\"":                                                                                true,
	"product.Service.Create:\"Produto inválido para importação simples\"":                                                                                true,
	...
	"integration.Service.InstallPagarmeHub#0":                                                                               true,
	"integration.Service.InstallPagarmeHub:\"Pagar.me Hub app não configurado\"":                                            true,
	"integration.Service.InstallPagarmeHub:\"Pagar.me Hub não retornou accessToken\"":                                       true,
	"integration.Service.InstallPagarmeHub:\"authorization_code é obrigatório\"":                                            true,
	...
	"integration.Service.searchERPProducts:\"Produto encontrado, mas sem estoque disponível no momento\"":                  true,
	"integration.Service.searchERPProducts:\"Produto não encontrado no ERP\"":                                              true,
