...
var baselineRawThrows = map[string]bool{
	...
	"live.Repository.ClearActiveProduct:\"event not found\"":                                    true,
	...
	"live.Repository.GetEventMedia:\"event not found\"":                                         true,
	"live.Repository.GetEventProductConfig:\"product not found\"":                               true,
	"live.Repository.GetEventPulse:\"event not found\"":                                         true,
	"live.Repository.GetEventWithCounts:\"event not found\"":                                    true,
	"live.Repository.GetLiveModeState:\"event not found\"":                                      true,
	...
	"live.Repository.SetActiveProduct:\"event not found\"":                                      true,
	"live.Repository.SetEventMedia:\"event not found\"":                                         true,
	"live.Repository.SetEventWindow:\"event not found\"":                                        true,
	"live.Repository.SetPixDiscountPercent:\"live event not found\"":                            true,
	"live.Repository.SetProcessingPaused:\"event not found\"":                                   true,
	"live.Repository.StartSession:\"live session not found\"":                                   true,
	"live.Repository.UpdateEventProduct:\"event product not found\"":                            true,
	...
	"notification.Handler.UpdateSettings#1":                                                     true,
	"notification.Handler.UpdateSettings#2":                                                     true,
